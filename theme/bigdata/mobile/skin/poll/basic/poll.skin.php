...
<aside id="poll" class="box">
    <header>
        ...
        <a href="<?php echo G5_BBS_URL."/poll_result.php?po_id=$po_id&amp;skin_dir=".urlencode($skin_dir); ?>" target="_blank" onclick="poll_result(this.href); return false;" class="btn_result" title="결과보기"><i class="fa fa-ellipsis-h"></i><span class="sound_only">결과보기</span></a>
    </header>
    <div class="poll_con">
        ...
        <input type="submit" value="투표하기" class="btn1 btn_submit">
