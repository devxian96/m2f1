...
<div id="mb_login" class="mbskin">
    ...
    <div id="login_frm">
        ...
        <div class="id_wr">
            ...
            <input type="text" name="mb_id" id="login_id" required class="login_input required" maxLength="20">
        ...
        <div class="auto">
            ...
            <label for="login_auto_login" class="login_auto_lb"><span class="agree_ck"></span>자동로그인</label>
        </div>
    ...
    $(function() {
        $('#login_id').focus(function() {
            $('.login_id').addClass('lb_focus');
        });
        $('#login_pw').focus(function() {
            $('.login_pw').addClass('lb_focus');
        });
    });
    </script>
    <?php
