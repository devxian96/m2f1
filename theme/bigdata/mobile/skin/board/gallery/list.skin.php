            ...
            <div class="gall_li_wr">
                ...
                <div class="gall_text_href">
                    ...
                    <span class="sound_only">작성자 </span><?php echo $list[$i]['name'] ?>
                        <span class="sound_only">작성일 </span><strong class="date"><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo $list[$i]['datetime2'] ?></strong>
                        <span class="sound_only">조회 </span><strong><i class="fa fa-eye" aria-hidden="true"></i> <?php echo $list[$i]['wr_hit'] ?></strong>
                        <?php if ($is_good) { ?><span class="sound_only">추천</span><strong class="gal_heart"><i class="fa fa-heart-o" aria-hidden="true"></i> <?php echo $list[$i]['wr_good'] ?></strong><?php } ?>
                    </div>
                </div>
            </div>
        </li>
