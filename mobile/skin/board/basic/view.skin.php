...
<!-- <div id="bo_v_table"><?php echo ($board['bo_mobile_subject'] ? $board['bo_mobile_subject'] : $board['bo_subject']); ?></div> -->
    <div class="btn_top top"> 
        <?php if ($reply_href) { ?><a href="<?php echo $reply_href ?>" class="btn_b02 btn"; style="background:#fff !important; color:#FB79A7 !important; padding-right:30px;"><i class="fa fa-reply" aria-hidden="true"></i> 답변</a><?php } ?>
        <?php if ($write_href) { ?><a href="<?php echo $write_href ?>" class="btn_b02 btn"  style="background:#fff !important; color:#FB79A7 !important; padding-right:30px;"><i class="fas fa-pen" aria-hidden="true"></i> 글쓰기</a><?php } ?>
...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <div id="bo_v_top">
        ...
        ob_start();
         ?>
        <ul class="bo_v_left">
            <?php if ($update_href) { ?><li><a href="<?php echo $update_href ?>" class="btn_b01 btn" style="background:#74CED7 !important; color: #ffffff;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 수정</a></li><?php } ?>
            <?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" class="btn_b01 btn" onclick="del(this.href); return false;" style="background:#74CED7 !important; color: #ffffff;"><i class="fas fa-trash-alt"></i> 삭제</a></li><?php } ?>
            <?php if ($copy_href) { ?><li><a href="<?php echo $copy_href ?>" class="btn_admin btn" onclick="board_move(this.href); return false;" style="background:#74CED7 !important; color: #ffffff;"><i class="fa fa-files-o" aria-hidden="true"></i> 복사</a></li><?php } ?>
            <?php if ($move_href) { ?><li><a href="<?php echo $move_href ?>" class="btn_admin btn" onclick="board_move(this.href); return false;" style="background:#74CED7 !important; color: #ffffff;"><i class="fas fa-expand-arrows-alt"></i> 이동</a></li><?php } ?>
    ...
    <section id="bo_v_atc">
        ...
        <div id="bo_v_share">
            <?php if ($scrap_href) { ?><a href="<?php echo $scrap_href;  ?>" target="_blank" class=" btn_scrap" onclick="win_scrap(this.href); return false;" style="background:#74CED7 !important; color: #ffffff;"><i class="fa fa-thumb-tack" aria-hidden="true"></i> 스크랩</a><?php } ?>
