...
<section id="bo_w">
    ...
    <div class="btn_top top write_div">
        <a href="./board.php?bo_table=<?php echo $bo_table ?>" class="btn_cancel" style="background:#74CED7 !important; color:#FFFFFF; padding:10px; border-radius:3px;">취소</a>
        <input type="submit" value="작성완료" id="btn_submit" class="btn_submit" accesskey="s" style="background:#74CED7 !important; color:#FFFFFF; padding:10px; border-radius:3px;">
    </div>
    </form>
</section>
