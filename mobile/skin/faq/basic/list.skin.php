...
<div id="faq_sch">
    ...
    <label for="stx" class="sound_only">검색어<strong class="sound_only"> 필수</strong></label><br><br>
    <input type="text" name="stx" value="<?php echo $stx;?>" required id="stx" class="frm_input" size="15" maxlength="15" style="width:800px;">
    <button type="submit" value="검색" class="btn_submit" style="margin-right:160px; margin-top:40px;"><i class="fa fa-search" aria-hidden="true" style="color:#FB79A7;"></i><span class="sound_only">검색</span></button>
    </form>
</div><br>
