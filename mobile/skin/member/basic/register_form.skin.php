...
<div style="margin-left:10%;">
    ...
    <div class="form_01" style="width:50%; float:left;">
		<br>
        <h2 style="font-size:20px; color:#74CED7"><i class="fas fa-info-circle"></i> 사이트 이용정보 입력</h2>
		
		<li>
		*아이디 &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <label for="reg_mb_id" class="sound_only">아이디<strong>필수</strong></label>
            <input type="text" name="mb_id" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" class="frm_input <?php echo $required ?> <?php echo $readonly ?>" minlength="3" maxlength="20" <?php echo $required ?> <?php echo $readonly ?> placeholder="아이디">
            <span id="msg_mb_id"></span>
			
			
        </li>
			<span style="color:royalblue;"> 영문자, 숫자, _ 만 입력 가능. 최소 3자이상 입력하세요.</span>
        <li>
		*비밀번호 &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <label for="reg_mb_password" class="sound_only">비밀번호<strong>필수</strong></label>
            <input type="password" name="mb_password" id="reg_mb_password" class="frm_input <?php echo $required ?>" minlength="3" maxlength="20" <?php echo $required ?> placeholder="비밀번호">
        </li>
        <li>
		*비밀번호확인 &nbsp;&nbsp;&nbsp;
            <label for="reg_mb_password_re" class="sound_only">비밀번호 확인<strong>필수</strong></label>
            <input type="password" name="mb_password_re" id="reg_mb_password_re" class="frm_input <?php echo $required ?>" minlength="3" maxlength="20" <?php echo $required ?>  placeholder="비밀번호확인">
        </li>
    </div>

    <div class="form_01"  style="width:50%; float:left;">
        
        <br><h2 style="font-size:20px; color:#74CED7"><i class="fas fa-info-circle"></i> 개인정보 입력</h2>
        <li class="rgs_name_li">
			*이름 &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <label for="reg_mb_name" class="sound_only">이름<strong>필수</strong></label>
            <input type="text" id="reg_mb_name" name="mb_name" value="<?php echo get_text($member['mb_name']) ?>" <?php echo $required ?> <?php echo $readonly; ?> class="frm_input  <?php echo $required ?> <?php echo $readonly ?>" placeholder="이름">
            <?php
        ...
        <li>
			...
			*닉네임 &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <input type="text" name="mb_nick" value="<?php echo isset($member['mb_nick'])?get_text($member['mb_nick']):''; ?>" id="reg_mb_nick" required class="frm_input  required nospace" maxlength="20" placeholder="닉네임" style="width:188px;">
        ...
        <li>
            <label for="reg_mb_email" class="sound_only">E-mail<strong>필수</strong></label>
                ...
                <?php }  ?>
				*이메일 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="hidden" name="old_email" value="<?php echo isset($member['mb_nick'])?get_text($member['mb_nick']):''; ?>">
                <input type="email" name="mb_email" value="<?php echo isset($member['mb_email'])?$member['mb_email']:''; ?>" id="reg_mb_email" required class="frm_input required nospace" maxlength="100" style="width:188px !important;" placeholder="E-mail">
    ...
    <div class="form_01">
		<br><h2 style="font-size:20px; color:#74CED7"><i class="fas fa-info-circle"></i> 기타 개인설정</h2>
        ...
        <li class="is_captcha_use" style="width:50%; float:left; margin-top:-106px;" >
            <span  class="frm_label" style="font-size:20px; color:#74CED7"><i class="fas fa-info-circle"></i> 자동등록방지</span>
	...
	<br><br><br>
    <div class="btn_top top" style="width:50%; float:left; ">
        <a href="<?php echo G5_URL; ?>/" class="btn_cancel" style="background:#74CED7; color:#ffffff; width:50px; height:50px;text-align:center; padding-top:15px;">취소</a>
        <input type="submit" value="<?php echo $w==''?'회원가입':'정보수정'; ?>" id="btn_submit" class="btn_submit" accesskey="s" style="background:#74CED7; color:#ffffff; width:70px; height:50px; text-align:center;">
    </div>
    </form>
