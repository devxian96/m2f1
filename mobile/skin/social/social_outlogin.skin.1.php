...
<div class="login-sns sns-wrap-32 sns-wrap-over" id="sns_outlogin">
	<h4 style="color:#BFBFBF;"><strong>SNS계정으로 로그인</strong></h4>
    <div class="sns-wrap">
        ...
        <br><a href="<?php echo $self_url;?>?provider=kakao&amp;url=<?php echo $urlencode;?>" class="sns-icon social_link sns-kakao" title="카카오">
			<span style=" padding-left:40px; ">KAKAO 계정으로 로그인하기</span>
            <span class="ico"></span>
